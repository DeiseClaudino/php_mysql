...
class ProdutoDao
{
    ...
    public function listaProdutos($conexao)
    {
        $produtos = array();
    ...
    public function insereProduto($conexao, Produto $produto)
    {
    ...
    public function removeProduto($conexao, $id)
    {
        $query = "delete from produtos where id = {$id}";
        return mysqli_query($conexao, $query);
    }

    public function buscaProduto($conexao, $id)
    {
    ...
    public function alteraProduto($conexao, Produto $produto)
    {
